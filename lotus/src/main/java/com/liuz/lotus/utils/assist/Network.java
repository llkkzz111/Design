package com.liuz.lotus.utils.assist;
...
public class Network {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            JLog.i("getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    JLog.i("NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    JLog.i("NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    JLog.i("NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    JLog.i("NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                JLog.i("\n");
            } else {
                JLog.i("getAllNetworkInfo is null");
            }
        }
        return false;
    }
    ...
    public static int getConnectedTypeINT(Context context) {
        NetworkInfo net = getConnectivityManager(context).getActiveNetworkInfo();
        if (net != null) {
            JLog.i("NetworkInfo: " + net.toString());
            return net.getType();
        }
        return -1;
    }
